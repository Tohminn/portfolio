            ...
            if(isset($_SESSION['expiration']) && is_string($_SESSION['expiration'])){
                ...
                if ($now <= $expiration){
                    ...
                    $response = [
                        ...
                        'aboutMe' => [
                            'intro' => 'My name is Gabe Owens and I am a Full-Stack Developer. Born and raised in central Illinois, I moved to Columbia, Missouri after high school to attend the University of Missouri (MU), where I would graduate with my Bachelors of Science in Information Technology.',
