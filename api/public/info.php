                ...
                if ($now <= $expiration){
                    ...
                    $response = [
                        ...
                        'aboutMe' => [
                            ...
                            'work_2' => 'In May of 2016, I left VU to work full-time as Chief Information Officer at Ulytic Inc, a company which I co-founded. Being the only full-time engineer, I was responsible for overseeing the entirety of the business\' software development and IT infrastructure. This allowed me to grow my knowledge in all aspects of development, from domain routing and load balanacing cloud server clusters to database design and large data storage. It also encouraged me to setup useful development systems such as Continuous Integration/Development and Continuous Deployment. Since Ulytic\'s primary function was to analyze video with computer vision, I was able to develop my skills in AI and Neural Networks, as well as design custom object tracking algorithms. In the fall of 2017, I led the design and development of a distributable software package that would be licensed to Panasonic as an add-on system to track parking lot vehicles.',
                            'wrap_up' => 'By following the SOLID principles and standards of Clean Code, I can write maintainable and expandable code in many languages. From attempting to start my own company, I\'ve become excellent at adapting my knowledge to quickly understand and work in new areas, as well as work in a fast changing, Agile environment. Based on these varied experiences, I\'ve become a "jack of all trades" developer and am confident that I could work on a wide range of projects for your business.'
                        ],
                        'projects' => [
                            [
                                'id' => 1,
